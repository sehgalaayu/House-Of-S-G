...
export const products: Product[] = [
  ...
  {
    code: "HSG-08",
    name: "Bedcover Set — Style TBC",
    category: "bedcovers",
    fabric: "Confirmed spec pending",
    finish: "Confirmed spec pending",
    size: "Confirmed spec pending",
    countNote: "Confirmed spec pending",
    swatch: "#c9c2b2",
    line: "rgba(22,34,59,0.12)",
    dark: false,
  ...
  {
    code: "HSG-10",
    name: "Comforter Set — Alternate Style TBC",
    category: "comforters",
    fabric: "Confirmed spec pending",
    finish: "Confirmed spec pending",
    size: "Confirmed spec pending",
